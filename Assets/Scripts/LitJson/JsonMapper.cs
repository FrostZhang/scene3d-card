...
namespace LitJson
{
    ...
    public class JsonMapper
    {
                ...
                while (true)
                {
                    ...
                    else
                    {
                        ...
                        ((IDictionary)instance).Add(
                            property, ReadValue(t_data.ElementType, reader));
                    }
                                        ...
                                        int depth)
        {
            ...
            {
                if (p_data.Info.IsDefined(typeof(LitjsonIgnore), false))
                    continue;
                if (p_data.IsField)
                {
        ...
        public static object ToObject(Type instype, string json)
        {
            JsonReader reader = new JsonReader(json);
            return ReadValue(instype, reader);
        }
        ...
        public static T ToObject<T>(T t, string json)
        {
            JsonReader reader = new JsonReader(json);

            return (T)ReadValue(t.GetType(), reader);
        }
